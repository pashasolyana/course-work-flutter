...
class _HomePageState extends State<HomePage> {
                    ...
                    child: Padding(
                      ...
                      child: Row(
                        children: [
                          ...
                          Text('Switch Currencies', style: TextStyle(color: Colors.indigo, fontSize: 17, fontWeight: FontWeight.w500))
                        ],
                      ),
                    ),
                  ),
                ...
                children: [
                  ...
                  TextFormField(
                    ...
                    decoration: InputDecoration(
                      ...
                      suffixIcon: Text(country.currency, style: TextStyle(fontSize: 20, color: Colors.grey)),
  ...
  _buildMenuCurrency(bool isDestination){
    showCupertinoDialog(context: context, builder: (_) => CupertinoActionSheet(
        actions: _buildListActions(onPressed: (index){
          setState(() {
            isDestination ? toCountry = datas[index] : fromCountry = datas[index];
            _requestConvert();
 ...
 List<Widget> _buildListActions({required Function(int) onPressed}){
   ...
   for(var i =0; i < datas.length; i++){
     listActions.add(CupertinoActionSheetAction(onPressed: () => onPressed(i), child: Text(datas[i].name)));
   }
   return listActions;
 }
}